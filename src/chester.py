...
if __name__ == "__main__":
    ...
    chester_intents = discord.Intents.default()
    chester_intents.message_content = True
    chester = Chester(command_prefix=">", intents=chester_intents)
    # load env and run bot
    dotenv.load_dotenv()
    chester.run(os.environ.get("DISCORD_BOT_TOKEN"))
